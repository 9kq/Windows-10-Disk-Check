...
# This will notify the user of a corrupted file or folder on the HDD/SSD then have the user reboot for it to then scan the drive for that corrupted file/folder
